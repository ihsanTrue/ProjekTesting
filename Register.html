...
<body>
    ...
    <div class="card-header gardient"
        style="width: 100%; border-radius: none; height: 250px; border: none; background-color: #18ffff; margin-top: 88px;">
        <br>
    ...
    <div class="row" style="width: 100%;">
        <div class="col-5">
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="No Handphone"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="email" class="form-control" name="email" placeholder="lorem@gmai.com">
                                </div>
                                <div class="col">
                        ...
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Foto KTP</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="ktp">
                                <label class="custom-file-label" for="ktp">Cari file</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Foto SIM</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="sim">
                                <label class="custom-file-label" for="sim">Cari file</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Foto Anda</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="foto">
                                <label class="custom-file-label" for="foto">Cari file</label>
                            </div>
                        </div>
                        <br>
            ...
            <div class="card w-100 ShadowBox" style="margin-left: 18px; margin-top: 20px; height: 50px; padding-top: 10px; padding-left: 10px;">
                <small style="font-size: 16px;">
                    <img src="icon/lock.png" alt="" width="30px">
